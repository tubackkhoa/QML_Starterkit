...
ListView {
    ...
    property color dividerColor: "lightgray"
    ...
    delegate: CheckDelegate {
        ...
        contentItem : Row {
            ...
            Repeater {
                ...
                Item {
                    ...
                    width: columns[index].width + r.dividerWidth
                    height: r.rowHeight
                    clip: true
                    Loader {
                        id: loader
        ...
        background: Rectangle {
            ...
            height: Math.min(rowData.implicitHeight, r.rowHeight)
            color: ((rowData.isCurrentItem) && (!r.checkable)) || ((r.checkable) && (rowData.checked)) ? r.currentColor :
                                                                                                         (rowData.hovered ? r.hoveredColor :                                                                                                                            ((rowData.rowIndex % 2) == 0 ? r.rowColor : r.rowAlternateColor))
        }
        indicator: Item {
            width: r.checkableWidth
            height: r.rowHeight
